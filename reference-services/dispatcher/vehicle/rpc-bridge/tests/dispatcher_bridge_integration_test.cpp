...
#include "../../../../backend-transport/vehicle/service/tests/mqtt_test_fixture.hpp"
...
private:
    static pid_t start_service(const std::string& name, int port) {
        ...
        if (name == "discovery") {
            executable = build_dir + "/reference-services/discovery/vehicle/service/ifex-discovery-service";
        } else if (name == "dispatcher") {
            executable = build_dir + "/reference-services/dispatcher/vehicle/service/ifex-dispatcher-service";
        } else if (name == "echo") {
