...
// Generated from: reference-specs/scheduler/common/scheduler-types.ifex.yml
...
# AUTO-GENERATED - DO NOT EDIT
# Flattened from: /home/saka/BALI/tvep-workspace/components/covesa-ifex-core/reference-specs/scheduler/common/scheduler-types.ifex.yml
# Regenerate with: ./generate_proto.sh
---
name: scheduler_types
major_version: 2
minor_version: 0
description: 'Common data types for scheduler services and sync protocol. Used by
  both vehicle scheduler-service and cloud-scheduler-service. Aligned with scheduler-sync-protocol-v2.md
  specification.

  '
namespaces:
- name: types
  description: Shared scheduler data types
  enumerations:
