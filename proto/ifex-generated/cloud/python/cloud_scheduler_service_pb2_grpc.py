...
class set_job_remote_version_serviceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.set_job_remote_version = channel.unary_unary(
                '/swdv.cloud_scheduler_service.set_job_remote_version_service/set_job_remote_version',
                request_serializer=cloud__scheduler__service__pb2.set_job_remote_version_request.SerializeToString,
                response_deserializer=cloud__scheduler__service__pb2.set_job_remote_version_response.FromString,
                )
...
def add_set_job_remote_version_serviceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'set_job_remote_version': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=cloud__scheduler__service__pb2.set_job_remote_version_request.FromString,
                    response_serializer=cloud__scheduler__service__pb2.set_job_remote_version_response.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'swdv.cloud_scheduler_service.set_job_remote_version_service', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class set_job_remote_version_service(object):
    ...
    def set_job_remote_version(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/swdv.cloud_scheduler_service.set_job_remote_version_service/set_job_remote_version',
            cloud__scheduler__service__pb2.set_job_remote_version_request.SerializeToString,
            cloud__scheduler__service__pb2.set_job_remote_version_response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
