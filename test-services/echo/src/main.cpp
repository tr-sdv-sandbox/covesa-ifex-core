...
#include "echo_service.ifex.h"  // Generated IFEX schema as embedded string
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        // Register with discovery using embedded IFEX schema if requested
        if (register_with_discovery) {
            ...
            if (!g_server->RegisterWithDiscovery(discovery_endpoint, port, ifex::schema::echo_service)) {
